 ...
 */
public class G_MainActivity extends AppCompatActivity {
    ...
    public void list() {
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> arg0, View arg1, int arg2, long arg3) {
                BluetoothDevice bluetoothDevice = G_MainActivity.this.pairedDevices.get(arg2);
                NavigationUtil.startGraphActivity(G_MainActivity.this, bluetoothDevice);
            }
        });
    }
